...
const ToolsPalette: React.FC<ToolsPaletteProps> = ({ activeTool, onToolSelect }) => {
  const tools: { id: Tool; label: string; icon: React.ReactElement; title: string }[] = [
    ...
    { id: 'color', label: 'Цвет', icon: <SwatchIcon />, title: "Настройки цвета: Точная настройка оттенка, насыщенности и яркости, глобально или для выбранной области." },
    ...
    { id: 'mix', label: 'Комбинировать', icon: <LayersIcon />, title: "Студия комбинирования: Загрузите несколько предметов одежды или аксессуаров и опишите, как их скомбинировать на вашей фотографии." },
